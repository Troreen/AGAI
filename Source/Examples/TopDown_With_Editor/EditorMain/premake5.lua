...
local projectname = "TopDownEditorMain"
project (projectname)
	location (dirs.projectfiles)
	dependson { "External", "Application", "TopDownGame", "Editor" }
	...
	links {"Core", "External", "Application", "TopDownGame", "Editor", "EditorDefaultGraphics" }
	...
	defines
	{
		"TGE_PROJECT_SETTINGS_FILE=\"TopDownGame.json\""
	}
