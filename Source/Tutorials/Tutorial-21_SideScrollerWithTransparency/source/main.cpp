...
void Go(void)
{
    ...
    cfg.applicationName = L"TGE: Tutorial 21 - Side Scroller";
    ...
    Tga::GraphicsEngine& graphicsEngine = *Tga::GraphicsEngine::GetInstance();
    {
        ...
        platformModel.SetTexture(0, 0, Tga::GraphicsEngine::GetInstance()->GetTextureManager().GetTexture("environment/gradientMap_c.tga"));
        ...
        characterModel.SetTexture(0, 0, Tga::GraphicsEngine::GetInstance()->GetTextureManager().GetTexture("character/atlas.tga"));

        ModelInstance cube = modelFactory.GetUnitCube();
        cube.SetTexture(0, 0, Tga::GraphicsEngine::GetInstance()->GetTextureManager().GetTexture("cubetexture.tga"));

        AnimationPlayer idleAnimation = modelFactory.GetAnimationPlayer("character/idle.fbx", characterModel.GetModel()->GetSkeleton());
        AnimationPlayer runAnimation = modelFactory.GetAnimationPlayer("character/run.fbx", characterModel.GetModel()->GetSkeleton());
        AnimationPlayer jumpAnimation = modelFactory.GetAnimationPlayer("character/jump.fbx", characterModel.GetModel()->GetSkeleton());
        ...
        tgeSpriteSharedData.texture = Tga::GraphicsEngine::GetInstance()->GetTextureManager().GetTexture("sprites/tge_logo_w.dds");
        ...
        for (unsigned int i = 0; i < 20000; i++)
        {
            ...
            instance.transform = Matrix4x4f::CreateFromScale(200.f);
            instance.transform.SetPosition(Tga::Vector3f(-10000.f + 20000.f*randomX, -5000.f  + 10000.f * randomY, 100 + 9900.f * randomZ));
            instance.color = Tga::Color(0.2f,0.3f,0.6f, 1);
            tgeSpriteInstances.push_back(instance);
        }

        Tga::SpriteSharedData fogPlaneSpriteSharedData;
        fogPlaneSpriteSharedData.texture = Tga::GraphicsEngine::GetInstance()->GetTextureManager().GetWhiteSquareTexture();

        Tga::SpriteSharedData effectSpriteSharedData;
        effectSpriteSharedData.texture = Tga::GraphicsEngine::GetInstance()->GetTextureManager().GetTexture("sprites/Particle.dds");

        Tga::SpriteSharedData cloudSpriteSharedData;
        cloudSpriteSharedData.texture = Tga::GraphicsEngine::GetInstance()->GetTextureManager().GetTexture("sprites/cloud.dds");

        Tga::Font font48 = Tga::GraphicsEngine::GetInstance()->GetTextService().GetOrLoad("Text/arial.ttf", Tga::FontSize_48);
        Tga::Font font18 = Tga::GraphicsEngine::GetInstance()->GetTextService().GetOrLoad("Text/arial.ttf", Tga::FontSize_18);
        ...
        while (bShouldRun)
        {
            ...
            // First draw everything using the 3d camera
            {
                ...
                // after this, draw transparent object, which has to be ordered back to front
                {
                    ...
                    {
                        Tga::Sprite3DInstanceData instance = {};
                        instance.transform = Matrix4x4f::CreateFromScale(20000.f);
                        instance.transform.SetPosition({ -10000, 10000, 100 + (float)i*1000 });
                        instance.color = { 0.1f,0.2f,0.5f,0.2f };
...

                            {
                                ...
                                for (int i = 0; i < 5; i++)
                                {
...

                                    {
                                        ...
                                        Tga::Sprite3DInstanceData instance = {};
                                        instance.transform = Matrix4x4f::CreateFromScale(10.f);
                                        instance.transform.SetPosition(position + Vector3f{ -0.5f * size, 0.5f * size, 0.f });
                    ...
                    // Mesh with alpha blending example
                    {
...

                        {
...

                            {
                                ...
                                Tga::Sprite3DInstanceData instance = {};
                                instance.transform = Matrix4x4f::CreateFromScale(size);
                                instance.transform.SetPosition(cube.GetTransform().GetPosition() + Vector3f{ -0.5f * size, 0.5f * size, 0.f });
                                instance.color = { 1.0f,0.5f,0.2f,0.5f };
...

                            {
                                ...
                                instance.transform = Matrix4x4f::CreateFromScale(size);
                                instance.transform.SetPosition(cube.GetTransform().GetPosition() + Vector3f{ -0.5f * size, 0.5f * size, 0.f });
                                instance.color = { 0.75f,1.0f,0.5f,0.5f };
