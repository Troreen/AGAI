...
void Go( void )
{
	Tga::LoadSettings(TGE_PROJECT_SETTINGS_FILE);
	{
		...
		while (true)
		{
			...
			myPlainText.Render();
			Tga::GraphicsEngine::GetInstance()->GetDebugDrawer().DrawArrow(myPlainText.GetPosition() + Tga::Vector2f(0, 0.03f), myPlainText.GetPosition() + Tga::Vector2f(myPlainText.GetWidth(), 0.03f));
