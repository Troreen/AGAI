...
void Go( void )
{
	Tga::LoadSettings(TGE_PROJECT_SETTINGS_FILE);
	{
		...
		sprite1Instance.pivot = Tga::Vector2f(0.5f, 0.5f);
		sprite2Instance.pivot = Tga::Vector2f(0.5f, 0.5f);
		sprite3Instance.pivot = Tga::Vector2f(0.5f, 0.5f);
		...
		customShader.SetTextureAtRegister(Tga::GraphicsEngine::GetInstance()->GetTextureManager().GetTexture("sprites/tge_logo_w.dds"), Tga::ShaderTextureSlot_1); // Add a texture
		...
		sprite1Shared.customShader = &customShader;
		sprite1Instance.position = Tga::Vector2f(0.5f, 0.4f);
		sprite1Instance.size = { 0.3f, 0.3f };
		...
		customShader2.SetTextureAtRegister(Tga::GraphicsEngine::GetInstance()->GetTextureManager().GetTexture("sprites/tge_logo_w.dds"), Tga::ShaderTextureSlot_1); // Add a texture																																				   // Run PostInit to set all the data
		customShader2.Init("shaders/instanced_sprite_shader_vs", "shaders/custom_sprite_pixel_shader_2_ps");

		// Tell the sprite to use this shader
		sprite2Shared.customShader = &customShader2;
		sprite2Instance.position = Tga::Vector2f(0.5f, 0.5f);
		sprite2Instance.size = { 0.3f, 0.3f };
		...
		customShader3.SetTextureAtRegister(Tga::GraphicsEngine::GetInstance()->GetTextureManager().GetTexture("sprites/tge_logo_w.dds"), Tga::ShaderTextureSlot_1); // Add a texture																																				   // Run PostInit to set all the data
		customShader3.Init("shaders/instanced_sprite_shader_vs", "shaders/custom_sprite_pixel_shader_3_ps");

		// Tell the sprite to use this shader
		sprite3Shared.customShader = &customShader3;
		sprite3Instance.position = Tga::Vector2f(0.5f, 0.6f);
		sprite3Instance.size = { 0.3f, 0.3f };
		...
		while (true)
		{
			...
			{
				Tga::Camera camera;
				float ratio = Tga::Application::GetInstance()->GetRenderSizeRatioInversed();
